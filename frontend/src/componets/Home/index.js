...
class Home extends Component {
    ...
    render() {
        const { barChartData, pieChartData, transactions } = this.state
            ...
            <div className="Home">
                ...
                <div className='dataTable4' style={{marginTop:"50px"}}>
                    <div className="sContainer">
                        <h1>Statistics:{this.state.month}</h1>
                        <div className='disignStyle'>
                            <div>Total Sale Amount: {this.state.statistics.totalSaleAmount}</div>
                            <div>Total Sold Items: {this.state.statistics.soldItems}</div>
                            <div>Total Not Sold Items: {this.state.statistics.notSoldItems}</div>
                        </div>
                    </div>
